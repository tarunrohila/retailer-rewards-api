...
/**
 * Implementation for @{@link CustomerDao} which is used to provide handling for customer operations
...
public class CustomerDaoImpl implements CustomerDao {
    ...
    public static final String UNABLE_TO_RETRIEVE_CUSTOMER_WITH_CUSTOMER_ID =
            "Customer does not exist with customerId = %s";
                ...
                .orElseThrow(
                        () ->
                                new CustomerException(
                                        String.format(
                                                UNABLE_TO_RETRIEVE_CUSTOMER_WITH_CUSTOMER_ID,
                                                customerId)));
    }
}
