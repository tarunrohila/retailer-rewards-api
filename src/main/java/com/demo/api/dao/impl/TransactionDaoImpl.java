...
/**
 * Implementation for @{@link TransactionDao} which is used to provide handling for customer transactions to interact with database
 *
 * @author Tarun Rohila
 * @since Mar 25, 2023
 */
...
public class TransactionDaoImpl implements TransactionDao {
    ...
    public static final String UNABLE_TO_CREATE_TRANSACTION_WITH_CUSTOMER_ID = "Unable to create a transaction = %s for customer with customerId = %s";
    ...
    public Transaction addTransaction(Transaction transaction) {
       try {
           ...
           throw new TransactionException(String.format(UNABLE_TO_CREATE_TRANSACTION_WITH_CUSTOMER_ID, transaction, transaction.getCustomer().getId()));
       }
    }
}
