...
/**
 * Implementation for @{@link RewardsDao} which is used to provide handling for methods for
...
public class RewardsDaoImpl implements RewardsDao {
    ...
    public static final String UNABLE_TO_FIND_CUSTOMER_WITH_CUSTOMER_ID =
            "Unable to find customer with customerId = %s";
    ...
    public List<Transaction> retrieveTransactionsForCustomer(Long customerId) {
        LOGGER.debug(
                "retrieving rewards for customerId = [{}] in RewardsDaoImpl.retrieveRewardsForCustomer",
                customerId);
        ...
        return rewardsRepository
                ...
                .orElseThrow(
                        () ->
                                new RewardsException(
                                        String.format(
                                                UNABLE_TO_FIND_CUSTOMER_WITH_CUSTOMER_ID,
                                                customerId)));
    }
}
