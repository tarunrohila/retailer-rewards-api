...
public class TransactionController {
    ...
    public ResponseEntity<?> addTransaction(@RequestBody TransactionRequest transaction) {
        LOGGER.info("Adding a transaction = [{}] for customerId = [{}]", transaction, transaction.getCustomerId());
        LOGGER.debug("Adding a transaction = [{}] for customerId = [{}] in RewardsController.retrieveRewardsForCustomer", transaction, transaction.getCustomerId());
